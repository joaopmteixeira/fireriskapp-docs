...
## UX-01 — Validação e invalidação de resultados nos subfatores
...
## UX-02 — Aviso de RI desatualizado na RiPage
...
## UX-03 — Colapsar/expandir subfatores em POI, DPI e ESCI
...
## UX-04 — Persistência do estado colapsado entre navegações
...
- O estado é lido no inicializador lazy do `useState` → sobrevive à navegação (desmontagem/remontagem do componente)
- Exemplo de chave: `collapse:poi:iee`

---

## UX-05 — Melhorias UX na RiPage (notice fade + gate de erros)
...
## UX-06 — Persistência de erros/avisos entre navegações nos subfatores
...
## UX-07 — Warning no subfator ao limpar + ERRO na RiPage
...
## UX-08 — Auto-atualização de resultados na RiPage + remoção do botão "Atualizar resultados"
