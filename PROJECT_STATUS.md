...
> Gerado por `/plans-missing` em 2026-07-01.
...
| UI-13 | FIR-54 | Painel admin de pedidos de suporte — `/app/admin/support` | ❌ Pendente | [✅ Sim](plans/subplans/UI/UI-13_UNDONE.md) | — |
...
| AUTH-08 | — | Regenerar sessão após login (mitigação session fixation) | ✅ Concluído | [✅ Sim](plans/subplans/AUTH/AUTH-08.md) | 2026-05-08 |
...
| AUTH-13 | — | Hardening sessão: max_age, Secure flag, CSRF protection | ✅ Concluído | [✅ Sim](plans/subplans/AUTH/AUTH-13.md) | 2026-05-22 |
| DB-01 | — | Neon PostgreSQL em produção | ✅ Concluído | [✅ Sim](plans/subplans/DB/DB-01.md) | 2026-05-08 |
| DB-02 | — | Migração Neon → Supabase — elimina cold start 45s | ✅ Concluído | [✅ Sim](plans/subplans/DB/DB-02.md) | — |
...
| SEC-02 | — | HTTPS obrigatório em produção — fail-fast URLs | ✅ Concluído | [✅ Sim](plans/subplans/SEC/SEC-02.md) | 2026-05-12 |
...
| SEC-08 | — | Remover legacyLogin.ts e VITE_LOGIN_* do .env | ✅ Concluído | [✅ Sim](plans/subplans/SEC/SEC-08.md) | 2026-05-22 |
...
| UI-07 | — | Dark Mode — tema escuro em todas as páginas | ✅ Concluído | [✅ Sim](plans/subplans/UI/UI-07.md) | 2026-05-18 |
| UI-11 | FIR-52 | Formulário de suporte técnico na LoginPage | ✅ Concluído | [✅ Sim](plans/subplans/UI/UI-11.md) | 2026-06-30 |
...
| BACK-01 | — | Migração Flask → FastAPI: routers, schemas, services, uvicorn | ✅ Concluído | [✅ Sim](plans/subplans/BACK/BACK-01.md) | 2026-05-15 |
| BACK-02 | — | Melhorar logging: failed logins, user-agent, request IDs | ✅ Concluído | [✅ Sim](plans/subplans/BACK/BACK-02.md) | 2026-05-12 |
| BACK-03 | — | ASCII enum values — remover ç/ã dos values DPI e aliases CTI | ✅ Concluído | [✅ Sim](plans/subplans/BACK/BACK-03.md) | — |
...
1. **UI-08** (FIR-33) — ícones ℹ️ nos subfatores; maior impacto visual/UX imediato para utilizadores sem formação no modelo
2. **UI-05** — formulário de Bug Report; complementa UI-11 (suporte técnico) e fecha o ciclo de feedback do utilizador
...
*Total: 92 · Em Progresso: 0 · Pendentes: 25 · Concluídos: 67 · Com plano: 74*
